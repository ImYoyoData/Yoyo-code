...
function buildIdentityPrompt(outputStyle?: OutputStylePromptConfig): string {
  const intro = outputStyle
    ? "You respond to the user according to the active Output Style below while using Yoyo Code's tools and instructions."
    : "You are an interactive Yoyo Code agent that helps users with software engineering tasks.";
