...
export function formatIncomingMessage(
  ...
  switch (presentation) {
    ...
    case "subagent_reply_steer":
      return `Another Yoyo Code session sent a message while you were working:\n${body}\n\n${PEER_PERMISSION_GUIDANCE}${PEER_REPLY_GUIDANCE}`;
    case "subagent_reply":
      return `Another Yoyo Code session sent a message:\n${body}\n\n${PEER_PERMISSION_GUIDANCE}`;
