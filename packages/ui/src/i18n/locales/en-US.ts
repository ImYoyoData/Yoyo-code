...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Yoyo Code to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let Yoyo Code remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Yoyo Code",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Yoyo Code.",
  ...
  "startup.global.starting_services": "Starting Yoyo Code",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Yoyo Code will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Yoyo Code or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Yoyo Code. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Yoyo Code to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Yoyo Code.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Yoyo Code restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Yoyo Code",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Yoyo Code and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to Yoyo Code",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to Yoyo Code",
  "login.description": "Connect your account to start using Yoyo Code",
  ...
  "logout.confirm.title": "Disconnect and restart Yoyo Code?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Yoyo Code Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About Yoyo Code",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Yoyo Code to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Yoyo Code CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Yoyo Code checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Yoyo Code terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While Yoyo Code is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .yoyo-code/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Yoyo Code installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Yoyo Code task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Yoyo Code",
  ...
  "resourceManager.storage.diskUsage": "Yoyo Code uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Yoyo Code desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Yoyo Code could not verify its Windows secure import component. Reinstall or update Yoyo Code before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Yoyo Code will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Yoyo Code Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Yoyo Code provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Yoyo Code Agent cannot refresh OAuth status. Upgrade or restart Yoyo Code, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Yoyo Code to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Yoyo Code",
  ...
  "settings.modelProvider.templateGroup.zhipu": "Yoyo Code",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Yoyo Code 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Yoyo Code automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Yoyo Code.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Yoyo Code uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.modelIdCatalog.title": "Available models",
  "settings.modelProvider.modelIdCatalog.count": "Available models ({count})",
  "settings.modelProvider.modelIdCatalog.loading": "Loading models…",
  "settings.modelProvider.modelIdCatalog.empty": "This provider returned no models",
  "settings.modelProvider.modelIdCatalog.filteredEmpty": "No matching models",
  "settings.modelProvider.modelIdCatalog.refresh": "Reload the model list",
  "settings.modelProvider.modelIdCatalog.failed": "Could not load the model list",
  "settings.modelProvider.modelIdCatalog.credentialsRequired":
    "Save this provider's Base URL and API key before loading its model list",
  "settings.modelProvider.modelIdCatalog.providerMissing":
    "This provider no longer exists. Refresh and try again.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Yoyo Code after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Yoyo Code MCP",
  ...
  "sidebar.usage.plan.mcp": "Yoyo Code MCP",
  "sidebar.usage.plan.zcodeMcp": "Yoyo Code MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for Yoyo Code built-in plugin MCPs",
  ...
  "settings.modelProvider.emptyState": "No model added yet",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Yoyo Code. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Yoyo Code follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Yoyo Code",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Yoyo Code Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Yoyo Code with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Yoyo Code and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Yoyo Code follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Yoyo Code",
  ...
  "settings.commands.description":
    "Manage Yoyo Code Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "Yoyo Code Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Yoyo Code. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Yoyo Code follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Yoyo Code",
  ...
  "settingsSync.action.finish": "Start using Yoyo Code",
  "settingsSync.agent.zcode": "Yoyo Code Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Yoyo Code settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Yoyo Code",
  ...
  "onboarding.welcome.title": "Welcome to Yoyo Code",
  "onboarding.welcome.start": "Start Yoyo Code",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Yoyo Code imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Yoyo Code will copy {source} to {target}.\nIf the target file already exists, the Yoyo Code default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Yoyo Code anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Yoyo Code anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Yoyo Code will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Yoyo Code to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Yoyo Code app and retry, or ask Yoyo Code to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Yoyo Code in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Yoyo Code: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Yoyo Code in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Yoyo Code Agent session",
  ...
  "chat.error.noAvailableModel": "No model available. Set a custom model in settings.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Yoyo Code MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Yoyo Code MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "Yoyo Code",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Yoyo Code Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Yoyo Code is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Yoyo Code can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Yoyo Code Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Yoyo Code Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Yoyo Code",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Yoyo Code to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Yoyo Code plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Yoyo Code will verify the Computer Use tools against the exact session when your first session starts.",
