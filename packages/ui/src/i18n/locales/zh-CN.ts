...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 Yoyo Code 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 Yoyo Code 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Yoyo Code 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Yoyo Code",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Yoyo Code。",
  ...
  "startup.global.starting_services": "正在启动 Yoyo Code",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Yoyo Code。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "startup.global.error.lock_timeout":
    "等待数据库写锁超时。请检查其他 Yoyo Code 或 CLI 进程是否仍在更新数据，待其完成后点击重试。",
  "startup.global.error.sql_failed":
    "准备过程未完成。请复制诊断信息查看日志，排除问题后手动重试。应用不会自动重试。",
  "startup.global.error.startup_status_timeout":
    "未能收到启动状态。请退出并重新打开 Yoyo Code；如果仍失败，请提供诊断信息。",
  "startup.global.error.transport_closed":
    "数据准备进程意外退出或连接中断。请退出并重新打开 Yoyo Code，应用会重新检查迁移记录。",
  "startup.global.error.unsupported_runtime":
    "当前配置的 Agent 不支持独立存储准备。请恢复配套的 Agent 后重新打开 Yoyo Code。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Yoyo Code 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 Yoyo Code",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 Yoyo Code 后重试",
  ...
  "login.title": "欢迎来到 Yoyo Code",
  "login.description": "连接账号，开始使用 Yoyo Code",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 Yoyo Code？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Yoyo Code Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 Yoyo Code",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Yoyo Code 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Yoyo Code CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Yoyo Code 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 Yoyo Code 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .yoyo-code/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Yoyo Code 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 Yoyo Code 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "Yoyo Code 总占用",
  ...
  "resourceManager.storage.diskUsage": "Yoyo Code 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Yoyo Code 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Yoyo Code 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Yoyo Code。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Yoyo Code 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 Yoyo Code Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Yoyo Code 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Yoyo Code Agent 不支持 OAuth 状态刷新。请升级或重启 Yoyo Code，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 Yoyo Code。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Yoyo Code",
  ...
  "settings.modelProvider.namePlaceholder": "如：Yoyo Code GLM",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 Yoyo Code 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 Yoyo Code 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 Yoyo Code 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Yoyo Code 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Yoyo Code 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.modelIdCatalog.title": "可选模型",
  "settings.modelProvider.modelIdCatalog.count": "可选模型（{count}）",
  "settings.modelProvider.modelIdCatalog.loading": "正在拉取模型列表…",
  "settings.modelProvider.modelIdCatalog.empty": "该供应商没有返回任何模型",
  "settings.modelProvider.modelIdCatalog.filteredEmpty": "没有匹配的模型",
  "settings.modelProvider.modelIdCatalog.refresh": "重新拉取模型列表",
  "settings.modelProvider.modelIdCatalog.failed": "拉取模型列表失败",
  "settings.modelProvider.modelIdCatalog.credentialsRequired":
    "请先保存该供应商的 Base URL 与 API Key，再拉取模型列表",
  "settings.modelProvider.modelIdCatalog.providerMissing": "该供应商已不存在，请刷新后重试",
  ...
  "settings.modelProvider.presetTitle": "Yoyo Code",
  ...
  "settings.modelProvider.emptyState": "暂未添加模型",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Yoyo Code 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "Yoyo Code 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Yoyo Code。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Yoyo Code 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Yoyo Code",
  ...
  "settings.subagents.description": "管理 Yoyo Code Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Yoyo Code 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Yoyo Code，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Yoyo Code 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Yoyo Code",
  ...
  "settings.commands.description":
    "管理 Yoyo Code Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Yoyo Code。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Yoyo Code 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Yoyo Code",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Yoyo Code 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Yoyo Code",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 Yoyo Code",
  "onboarding.welcome.start": "开始使用 Yoyo Code",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Yoyo Code 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Yoyo Code 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Yoyo Code 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Yoyo Code 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 Yoyo Code 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 Yoyo Code 应用后重试，或让 Yoyo Code 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Yoyo Code 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Yoyo Code 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 Yoyo Code 修订后另存一版。",
  ...
  "chat.error.noAvailableModel": "当前没有可用模型。请在设置里配置自定义模型。",
  ...
  "chat.quota.mcp.quotaExhausted": "Yoyo Code MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Yoyo Code MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Yoyo Code 报错信息",
  ...
  "offPeak.keepAwakeBanner": "Yoyo Code 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Yoyo Code 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Yoyo Code 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Yoyo Code 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Yoyo Code",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Yoyo Code 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Yoyo Code 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Yoyo Code 会针对该会话精确验证电脑控制工具。",
