...
const PRODUCTION_IDENTITY = Object.freeze({
  flavor: "production",
  appId: "dev.yoyocode.app",
  productName: "Yoyo Code",
  linuxExecutableName: "yoyo-code",
  linuxPackageName: "yoyo-code",
  cuaHelperInstallVariant: null,
});

const PREVIEW_IDENTITY = Object.freeze({
  flavor: "preview",
  appId: "dev.yoyocode.app.preview",
  productName: "Yoyo Code Preview",
  linuxExecutableName: "yoyo-code-preview",
  linuxPackageName: "yoyo-code-preview",
...
export function resolveWindowsAppUserModelIdForFlavor(flavor, runtime = { isPackaged: true }) {
  if (runtime.isPackaged === false) {
    return "dev.yoyocode.app.development";
  }
