...
const WORKFLOW_NAME = "Open in Yoyo Code.workflow";
const WORKFLOW_BUNDLE_ID = "dev.yoyocode.app.finder-open-workflow";
const WORKFLOW_VERSION = "5";
const SERVICES_MENU_LABELS: Record<Locale, string> = {
  "zh-CN": "在Yoyo Code中打开",
  "en-US": "Open in Yoyo Code",
};
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "yoyo-code://workspace/open?path=\${encoded}"
fi
`;
