...
function renderWebAuthCallbackPage(): void {
  document.title = "Yoyo Code - Sign In";
...
async function renderConversationSharePage(): Promise<void> {
  ...
  document.title = routeLocale === "zh-CN" ? "Yoyo Code 会话分享" : "Yoyo Code Conversation Share";
...
async function bootstrapWebApp() {
  ...
  try {
    ...
    document.title = "Yoyo Code - Web + Server";
